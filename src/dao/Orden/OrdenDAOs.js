...
class OrdenDAOs {
    static obtenerOrden(sqlConsulta, parametros, res) {
    ...
    static buscarOrdenPorId(sqlBuscar, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static crearOrden(sqlCrear, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static actualizarOrden(sqlActualizar, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield connectionBD_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
